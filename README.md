...
> - 📄 **PDF Export** is disabled in the live demo — QuestPDF is not supported on the free Azure hosting tier. Excel export remains fully functional.
...
- The .NET Web MVC is deployed to **[Azure Web App](https://airport-automation-mvc-d8ekhabyg5dgeedk.switzerlandnorth-01.azurewebsites.net/)**.
