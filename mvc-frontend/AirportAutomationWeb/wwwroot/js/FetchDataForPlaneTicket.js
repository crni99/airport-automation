...
function populateSelectPlaneTicket() {
    ...
    getData('/Passenger/GetPassengers', passengerSelect, 'firstName', 'lastName', 'uprn', currentPage);
    getData('/TravelClass/GetTravelClasses', classSelect, 'type', '', '', currentPage);
    getData('/Flight/GetFlights', flightSelect, 'departureDate', 'departureTime', '', currentPage);
    currentPage++;
}

document.addEventListener('DOMContentLoaded', function () {
    populateSelectPlaneTicket();
});