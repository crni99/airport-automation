...
export const errorMessageMap = {
    ...
    404: (dataType, dataId) => `Not found: The requested data does not exist.`,
    405: 'Method not allowed: The request method is not supported for the requested resource.',
    409: (dataType, dataId) => `Conflict: The requested operation cannot be completed due to conflicts with existing data.`,
